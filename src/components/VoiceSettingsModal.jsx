          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="font-serif font-bold text-xl text-indigo-deep">Voice & Dictation Settings</h3>
              ...
              <p className="text-xs text-indigo-muted">Punctuation reading, word pauses & handwriting pace</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto space-y-4 pr-1">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-mono uppercase tracking-wider text-indigo-muted font-semibold block mb-1">
              Available Free Indian Voices ({voices.length})
            </label>
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="truncate">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="px-1.5 py-0.2 rounded text-[10px] font-mono bg-amber-50 text-amber-800 border border-amber-200">
                            {voice.lang}
                          </span>
                        </div>
                      </div>
